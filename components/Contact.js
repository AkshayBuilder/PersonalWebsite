...
{
    e.preventDefault();
    const mailtoLink = `mailto:namiarakshayg@mail.com?subject=Contact from ${formData.name}&body=Name: ${formData.name}%0AEmail: ${formData.email}%0AMessage: ${formData.message}`;
